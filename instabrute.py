...
# Ennter instagram account Username  :
print()
my_username = input(color.GREEN + '[~] ' + color.CWHITE + 'Enter instagram account Username for BruteForce Attack ')
...
# Using error message for printing password Not found
	except Exception as err:
		print()
		print (color.GREEN + 'Password Not Found [!] ')
		browser.quit()
